...
processed_textdata1, class1 = loadtrainset("D:\1\bayes_train_test.txt", "宾馆")
processed_textdata2, class2 = loadtrainset("D:\1\bayes_train_test.txt", "旅游")
